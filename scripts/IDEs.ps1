...
winget install -e -h --id Microsoft.VisualStudio.2022.Enterprise --silent --override "--wait --quiet --addProductLang En-us --config $env:USERPROFILE\devsetup\config\vs2022\.vsconfig"
